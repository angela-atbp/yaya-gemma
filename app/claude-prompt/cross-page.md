...
## Issues we're facing: 
  * When user generates using one of the features above, other recipes are overriden (unexpected) and user can not see the recipe from the place they expect it to appear.

## Suggested solution:
  * Split or create dedicated Recipe generation function to avoid cross-hair effect
